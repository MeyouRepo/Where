...
public class ForResultExample2 extends Common {
  ...
  public static final int REQUEST_OR_RESULT_CODE_FOR_RESULT_EXAMPLE = 3210;
  public static final String EXTRA_FOR_RESULT_EXAMPLE = "RESULT";
  ...
  public void onBackPressed() {
    setResult(
        REQUEST_OR_RESULT_CODE_FOR_RESULT_EXAMPLE,
        getIntent(Show.class)
            .putExtra(
                EXTRA_FOR_RESULT_EXAMPLE,
                ((EditText) findViewById(R.id.EditText_On_ForResultExample)).getText().toString())
