...
public class MyExpandableListViewAdapter extends BaseExpandableListAdapter {
  ...
  public MyExpandableListViewAdapter(
      Context context, HashMap<String, List<String>> ChildTitles, List<String> HeaderTitles) {
  ...
  public View getGroupView(
    ...
    TextView textView =
        (TextView) convertView.findViewById(R.id.TextViewHeader_On_ExpandableListViewExample);
