...
public class PassingValueExample2 extends Common {
  ...
  public static final String EXTRA_PASSING_VALUE_EXAMPLE = "PASSING_VALUE_EXAMPLE";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    else textView.setText(getIntent().getStringExtra(EXTRA_PASSING_VALUE_EXAMPLE));
