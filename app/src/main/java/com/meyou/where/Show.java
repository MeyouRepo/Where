...
public class Show extends Common implements MyInterface {
  ...
  private String[] cities = {
    "衡阳", "长沙", "湘潭", "武汉", "北京", "重庆", "四川", "防城港", "上海", "大连", "株洲", "广州", "南宁", "乌鲁木齐"
  };

  private String[] textSwitcherExampleTexts = {
  ...
  private int[] imageSwitcherImages = {
    R.drawable.xxx_1, R.drawable.xxx_2, R.drawable.xxx_3, R.drawable.xxx_4, R.drawable.xxx_5
  };

  private int[] adapterViewFlipperImages = {
    R.drawable.fff_1, R.drawable.fff_2, R.drawable.fff_3, R.drawable.fff_4, R.drawable.fff_5
  };
  ...
  private void phoneDetailsExample() {
    ...
    ((TextView) findViewById(R.id.TextView_On_GetPhoneDetailsExample))
        .setText(phoneDetailsExampleText);
  }
  ...
  private void activityLifecycleExample() {
    if (getLoadValue() == 46) {
      ...
      ((TextView) findViewById(R.id.TextView_B_On_ActivityLifecycleExample))
          .setText(activityLifecycleExampleText);
  ...
  protected void onCreate(Bundle bundle) {
    ...
    switch (getLoadValue()) {
      ...
      case 3:
        ...
        findViewById(R.id.Button_Example)
      ...
      case 9:
        ...
        sw9.setOnClickListener(
            new View.OnClickListener() {
              @Override
              public void onClick(View view) {
                if (sw9.isChecked()) tV9.setText("Switch处于开启状态");
                else tV9.setText("Switch处于关闭状态");
              }
            });
        break;
      case 10:
                ...
                new AdapterView.OnItemSelectedListener() {
                  ...
                  public void onItemSelected(
                    ...
                    ((TextView) findViewById(R.id.text_on_spinner))
                        .setText("你最喜欢的城市是：" + cities[position]);
                  }
      ...
      case 11:
        ...
        autoCompleteTextView.setAdapter(
            new ArrayAdapter<>(
                getApplicationContext(), android.R.layout.simple_expandable_list_item_1, cities));

        setViewRadius(getRadius(), autoCompleteTextView);

        ((TextView) findViewById(R.id.TextView_On_AutoCompleteTextViewExample))
            .setTextColor(getLoadColor());

        break;
      case 12:
        CheckedTextView checkedTextView =
            findViewById(R.id.CheckedTextView_On_CheckedTextViewExample);
        checkedTextView.setTextColor(getLoadColor());
        checkedTextView.setOnClickListener(v -> Show.this.onClick(v));
        break;
      case 13:
        ((TextView) findViewById(R.id.TextView_On_TextSwitcherExample))
            .setTextColor(getLoadColor());
        ((TextSwitcher) findViewById(R.id.TextSwitcher_On_TextSwitcherExample))
            .setFactory(
                () -> {
        ...
        moreTouch(
            R.id.Button_Right_On_TextSwitcherExample, R.id.Button_Left_On_TextSwitcherExample);

        break;
      case 14:
        ((TextView) findViewById(R.id.TextView_On_ImageSwitcherExample))
            .setTextColor(getLoadColor());
        ((ImageSwitcher) findViewById(R.id.ImageSwitcher_On_ImageSwitcherExample))
            .setFactory(
                () -> {
        ...
        moreTouch(
            R.id.Button_Right_On_ImageSwitcherExample, R.id.Button_Left_On_ImageSwitcherExample);

        break;
      case 15:
        ((TextView) findViewById(R.id.TextView_On_AdapterViewFlipperExample))
            .setTextColor(getLoadColor());

        ((AdapterViewFlipper) findViewById(R.id.AdapterViewFlipper_On_AdapterViewFilterExample))
            .setAdapter(
                new AdapterViewFlipperAdapter(adapterViewFlipperImages, adapterViewFlipperTexts));
        ((AdapterViewFlipper) findViewById(R.id.AdapterViewFlipper_On_AdapterViewFilterExample))
            .setAutoStart(true);

        break;
      case 16:
        findViewById(R.id.ImageButton_On_ImageButtonExample)
            .setOnClickListener(
                new View.OnClickListener() {
                  @Override
                  public void onClick(View v) {
                    ((TextView) findViewById(R.id.TextView_On_ImageButtonExample))
                        .setText("你点击了ImageButton");
                  }
                });
        break;
      case 18:
      ...
      case 25:
        ...
        break;
      case 26:
        ((TextView) findViewById(R.id.TextView_On_ChangeWIFIStateExample))
            .setTextColor(getLoadColor());
        moreTouch(R.id.Button_A_On_ChangeWIFIStateExample, R.id.Button_B_On_ChangeWIFIStateExample);
        break;
      case 29:
        ((TextView) findViewById(R.id.TextView_On_ActivityTransitionExample))
            .setTextColor(getLoadColor());
        moreTouch(R.id.Button_A_On_ActivityTransition, R.id.Button_B_On_ActivityTransition);
        break;
      case 30:
        ((EditText) findViewById(R.id.EditText_On_PassingValueExample))
            .setTextColor(getLoadColor());
      ...
      case 31:
        ...
        break;
      case 32:
        ((ListView) findViewById(R.id.ListView_On_ListViewExample))
            .setAdapter(
                new ArrayAdapter<>(
                    getContext(), android.R.layout.simple_list_item_1, listViewExampleTexts));
        break;
      case 33:
        ((ExpandableListView) findViewById(R.id.ExpandableListView_On_ExpandableListViewExample))
            .setAdapter(
                new MyExpandableListViewAdapter(
                    getApplicationContext(),
                    MyExpandableListViewAdapter.ChildProvider.getInfo(),
                    new ArrayList<>(MyExpandableListViewAdapter.ChildProvider.getInfo().keySet())));
        break;
      case 34:
        ((GridView) findViewById(R.id.GridView_On_GridViewExample))
            .setAdapter(
                new ArrayAdapter<>(
                    getApplicationContext(),
                    android.R.layout.simple_list_item_1,
                    gridViewExampleTexts));
        break;
      case 35:
      ...
      case 36:
        ...
        ((SearchView) findViewById(R.id.SearchView_On_SearchViewExample))
        ...
        ((ListView) findViewById(R.id.ListView_On_SearchViewExample))
            .setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                  @Override
                  public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ((SearchView) findViewById(R.id.SearchView_On_SearchViewExample))
                        .setQuery(arrayAdapter.getItem(position), false);
                  }
                });
      ...
      case 37:
        ...
        break;
      case 38:
        ((DatePicker) findViewById(R.id.DatePicker_On_DatePickerExample))
            .init(
        ...
        break;
      case 39:
        ((TimePicker) findViewById(R.id.TimePicker_On_TimePickerExample))
        ...
        break;
      case 40:
        ((TextView) findViewById(R.id.TextView_On_TextInputEditTextExample))
            .setTextColor(getLoadColor());
        oneTouch(R.id.Button_On_TextInputEditTextExample);
        break;
      case 41:
        findViewById(R.id.FloatingActionButton_FloatingActionButtonExample)
            .setOnClickListener(
                new View.OnClickListener() {
                  @Override
                  public void onClick(View v) {
        ...
        ((TextView) findViewById(R.id.TextView_On_FloatingActionButtonExample))
            .setTextColor(getLoadColor());
        break;
      case 42:
        final TextView tV42 = findViewById(R.id.TextView_On_BottomNavigationViewExample);
        BottomNavigationView bottomNavigationView =
            findViewById(R.id.BottomNavigationView_On_BottomNavigationViewExample);
        ...
        break;
      case 43:
        ((TextView) findViewById(R.id.TextView_On_NavigationViewExample))
            .setTextColor(getLoadColor());
        break;
      case 44:
        setViewRadius(
      ...
      case 45:
        ...
        BottomSheetBehavior.from(findViewById(R.id.RelativeLayout_On_NestedScrollViewExample))
                ...
                new BottomSheetBehavior.BottomSheetCallback() {
                  ...
                  public void onStateChanged(@NonNull View view, int i) {
                    if (i == BottomSheetBehavior.STATE_COLLAPSED)
                      ((TextView) findViewById(R.id.TextView_On_NestedScrollViewExample))
                          .setText("上滑以打开NestedScrollView");
                    else if (i == BottomSheetBehavior.STATE_EXPANDED)
                      ((TextView) findViewById(R.id.TextView_On_NestedScrollViewExample))
                          .setText("下滑以关闭NestedScrollView");
                  }
        ...
        break;
      case 46:
        ((TextView) findViewById(R.id.TextView_A_On_ActivityLifecycleExample))
            .setTextColor(getLoadColor());
        ((TextView) findViewById(R.id.TextView_B_On_ActivityLifecycleExample))
            .setTextColor(getLoadColor());
        break;
      ...
      case 54:
        moreTouch(
            R.id.Button_Left_On_FadeAnimationExample, R.id.Button_Right_On_FadeAnimationExample);
        break;
      case 55:
        moreTouch(
            R.id.Button_Left_On_ZoomAnimationExample, R.id.Button_Right_On_ZoomAnimationExample);
        break;
      case 56:
        moreTouch(
            R.id.Button_Left_On_RotateAnimationExample,
            R.id.Button_Right_On_RotateAnimationExample);
        break;
      case 57:
        moreTouch(
            R.id.Button_Left_On_TranslateAnimationExample,
            R.id.Button_Up_On_TranslateAnimationExample);

        moreTouch(
            R.id.Button_Right_On_TranslateAnimationExample,
            R.id.Button_Down_On_TranslateAnimationExample);
        break;
      case 58:
        moreTouch(
            R.id.Button_Left_On_SlideAnimationExample, R.id.Button_Up_On_SlideAnimationExample);

        moreTouch(
            R.id.Button_Right_On_SlideAnimationExample, R.id.Button_Down_On_SlideAnimationExample);
        break;
      case 59:
      ...
      case 61:
        moreTouch(
            R.id.Button_Left_On_ScaleAnimationExample, R.id.Button_Right_On_ScaleAnimationExample);
        break;
      case 62:
      ...
      case 64:
        moreTouch(
            R.id.Button_Left_On_SharedPreferenceExample,
      ...
      case 70:
        ...
        ((TextView) findViewById(R.id.TextView_Right_On_XMLParsingExample))
            .setTextColor(getLoadColor());
      ...
      case 71:
        ...
        ((EditText) findViewById(R.id.EditText_Name_On_SQLiteInsertExample))
            .setTextColor(getLoadColor());
        ((EditText) findViewById(R.id.EditText_Sex_On_SQLiteInsertExample))
            .setTextColor(getLoadColor());
        ((EditText) findViewById(R.id.EditText_Hobbies_On_SQLiteInsertExample))
            .setTextColor(getLoadColor());
        break;
      case 72:
        oneTouch(R.id.Button_On_SQLiteDeleteExample);
        ((EditText) findViewById(R.id.EditText_Id_On_SQLiteDeleteExample))
            .setTextColor(getLoadColor());
        break;
      case 73:
        oneTouch(R.id.Button_On_SQLiteUpdateExample);
        ((EditText) findViewById(R.id.EditText_Id_On_SQLiteUpdateExample))
            .setTextColor(getLoadColor());
        ((EditText) findViewById(R.id.EditText_Name_On_SQLiteUpdateExample))
            .setTextColor(getLoadColor());
        ((EditText) findViewById(R.id.EditText_Sex_On_SQLiteUpdateExample))
            .setTextColor(getLoadColor());
        ((EditText) findViewById(R.id.EditText_Hobbies_On_SQLiteUpdateExample))
            .setTextColor(getLoadColor());
        break;
      case 74:
  ...
  public void onClick(View view) {
    ...
    if (viewId == R.id.Button_Example) {
      ((Button) findViewById(R.id.Button_Example)).setText("你点击了我");
    } else if (viewId == R.id.Button_On_CheckBoxExample) {
    ...
    } else if (viewId == R.id.Button_On_RatingBarExample) {
      ((Button) findViewById(R.id.Button_On_RatingBarExample))
          .setText(String.valueOf(((RatingBar) findViewById(R.id.RatingBar_Example)).getRating()));
    } else if (viewId == R.id.Button_On_ProgressBarExample) {
      startThread(
          new Thread() {
            @Override
            public void run() {
              ...
              while (i <= 100) {
                try {
                  ((ProgressBar) findViewById(R.id.ProgressBar_On_ProgressBarExample))
                      .setProgress(i);
                  i += 10;
                  sleep(1000);
    ...
    } else if (viewId == R.id.CheckedTextView_On_CheckedTextViewExample) {
      ((CheckedTextView) findViewById(R.id.CheckedTextView_On_CheckedTextViewExample)).toggle();
    } else if (viewId == R.id.Button_Right_On_TextSwitcherExample) {
      if (switcherExamplePosition < textSwitcherExampleTexts.length - 1) {
        switcherExamplePosition += 1;
        ((TextSwitcher) findViewById(R.id.TextSwitcher_On_TextSwitcherExample))
            .setText(textSwitcherExampleTexts[switcherExamplePosition]);
      }
    } else if (viewId == R.id.Button_Left_On_TextSwitcherExample) {
      if (switcherExamplePosition > 0) {
        switcherExamplePosition -= 1;
        ((TextSwitcher) findViewById(R.id.TextSwitcher_On_TextSwitcherExample))
            .setText(textSwitcherExampleTexts[switcherExamplePosition]);
      }
    } else if (viewId == R.id.Button_Right_On_ImageSwitcherExample) {
      if (switcherExamplePosition < imageSwitcherImages.length - 1) {
        switcherExamplePosition += 1;
        findViewById(R.id.ImageSwitcher_On_ImageSwitcherExample)
            .setBackgroundResource(imageSwitcherImages[switcherExamplePosition]);
      }
    } else if (viewId == R.id.Button_Left_On_ImageSwitcherExample) {
      if (switcherExamplePosition > 0) {
        switcherExamplePosition -= 1;
        findViewById(R.id.ImageSwitcher_On_ImageSwitcherExample)
            .setBackgroundResource(imageSwitcherImages[switcherExamplePosition]);
      }
    } else if (viewId == R.id.Button_On_EmailExample) {
    ...
    } else if (viewId == R.id.Button_On_MapsExample) {
      try {
        startActivity(
            Intent.createChooser(
                new Intent(Intent.ACTION_VIEW).setData(Uri.parse("geo:112.5545,27.5429")),
                "Launch Maps"));
      } catch (ActivityNotFoundException e) {
        ((TextView) findViewById(R.id.TextView_On_MapsExample)).setText("手机上没有地图APP");
      }
    } else if (viewId == R.id.Button_On_PhoneCallExample) {
      if (((EditText) findViewById(R.id.EditText_On_PhoneCallExample))
          .getText()
          .toString()
          .trim()
          .isEmpty()) {
        ...
        startActivity(
            new Intent(Intent.ACTION_DIAL)
                .setData(
                    Uri.parse(
                        "tel:"
                            + ((EditText) findViewById(R.id.EditText_On_PhoneCallExample))
                                .getText()
                                .toString())));
      }
    } else if (viewId == R.id.Button_On_CameraExample) {
      startActivityForResult(
          new Intent(MediaStore.ACTION_IMAGE_CAPTURE), REQUEST_OR_RESULT_CODE_CAMERA_EXAMPLE);
    } else if (viewId == R.id.Button_On_GetPhoneDetailsExample) {
      if (ContextCompat.checkSelfPermission(
              getApplicationContext(), Manifest.permission.READ_PHONE_STATE)
          == PackageManager.PERMISSION_GRANTED) phoneDetailsExample();
      else
        ActivityCompat.requestPermissions(
            Show.this,
            new String[] {Manifest.permission.READ_PHONE_STATE},
            REQUEST_PERMISSION_CODE_GET_PHONE_DETAILS);
    } else if (viewId == R.id.Button_A_On_ChangeWIFIStateExample) {
      ((WifiManager) getApplicationContext().getSystemService(Context.WIFI_SERVICE))
          .setWifiEnabled(true);
      ((TextView) findViewById(R.id.TextView_On_ChangeWIFIStateExample)).setText("WIFI OPENED");
    } else if (viewId == R.id.Button_B_On_ChangeWIFIStateExample) {
      ((WifiManager) getApplicationContext().getSystemService(Context.WIFI_SERVICE))
          .setWifiEnabled(false);
      ((TextView) findViewById(R.id.TextView_On_ChangeWIFIStateExample)).setText("WIFI CLOSED");
    } else if (viewId == R.id.Button_A_On_ActivityTransition
        || viewId == R.id.Button_B_On_ActivityTransition) {
      startActivity(
          getIntent(ActivityTransitionExample2.class)
    ...
    } else if (viewId == R.id.Button_On_PassingValueExample) {
      startActivity(
          getIntent(PassingValueExample2.class)
              .putExtra(PROPERTY, getLoadValue())
              .putExtra(PROPERTY_TITLE, getPropertyTitle())
              .putExtra(
                  PassingValueExample2.EXTRA_PASSING_VALUE_EXAMPLE,
                  ((EditText) findViewById(R.id.EditText_On_PassingValueExample))
                      .getText()
                      .toString())
              .putExtra(SHOW_CODE_PASSING, getLoadValue()));
      overridePendingTransition(R.anim.next_yan, R.anim.next_to_code);
    } else if (viewId == R.id.Button_On_ForResultExample) {
      startActivityForResult(
          getIntent(ForResultExample2.class)
              .putExtra(PROPERTY, getLoadValue())
              .putExtra(PROPERTY_TITLE, getPropertyTitle())
              .putExtra(SHOW_CODE_PASSING, getLoadValue()),
          ForResultExample2.REQUEST_OR_RESULT_CODE_FOR_RESULT_EXAMPLE);
      overridePendingTransition(R.anim.next_yan, R.anim.next_to_code);
    } else if (viewId == R.id.Button_On_PopUpMenuExample) {
      final PopupMenu popupMenu =
          new PopupMenu(getApplicationContext(), findViewById(R.id.Button_On_PopUpMenuExample));
    ...
    } else if (viewId == R.id.Button_On_TextInputEditTextExample) {
    ...
    } else if (viewId == R.id.FloatingActionButton_FloatingActionButtonExample) {
      ((TextView) findViewById(R.id.TextView_On_FloatingActionButtonExample))
          .setText("你点击了\nFloatingActionButton");
    } else if (viewId == R.id.Button_On_NestedScrollViewExample) {
      if (BottomSheetBehavior.from(findViewById(R.id.RelativeLayout_On_NestedScrollViewExample))
              .getState()
    ...
    } else if (viewId == R.id.Button_Start_On_Service_Lifecycle_Example) {
      startService(new Intent(getContext(), Service.class));
    } else if (viewId == R.id.Button_Stop_On_Service_Lifecycle_Example) {
      stopService(new Intent(getContext(), Service.class));
    } else if (viewId == R.id.Button_Bind_On_Service_Lifecycle_Example) {
      bindService(
          new Intent(getContext(), ServiceExample.class), serviceConnection, BIND_AUTO_CREATE);
      onBinding = true;
    } else if (viewId == R.id.Button_Unbind_On_Service_Lifecycle_Example) {
      if (onBinding) {
        unbindService(serviceConnection);
        ((Button) findViewById(R.id.Button_Bind_On_Service_Lifecycle_Example)).setText("绑定服务");
        onBinding = false;
      }
    } else if (viewId == R.id.Button_Left_On_FadeAnimationExample) {
      findViewById(R.id.ImageView_On_FadeAnimationExample)
          .startAnimation(loadAnimation(android.R.anim.fade_in));
      findViewById(R.id.ImageView_On_FadeAnimationExample).setVisibility(View.VISIBLE);
    } else if (viewId == R.id.Button_Right_On_FadeAnimationExample) {
      findViewById(R.id.ImageView_On_FadeAnimationExample)
          .startAnimation(loadAnimation(android.R.anim.fade_out));
      findViewById(R.id.ImageView_On_FadeAnimationExample).setVisibility(View.GONE);
    } else if (viewId == R.id.Button_Left_On_RotateAnimationExample) {
    ...
    } else if (viewId == R.id.Button_Right_On_RotateAnimationExample) {
    ...
    } else if (viewId == R.id.Button_Left_On_TranslateAnimationExample) {
      fromX = toX;
      toX -= 0.2f;
      fromY = toY;
    ...
    } else if (viewId == R.id.Button_Up_On_TranslateAnimationExample) {
      fromY = toY;
      toY -= 0.2f;
      fromX = toX;
    ...
    } else if (viewId == R.id.Button_Right_On_TranslateAnimationExample) {
      fromX = toX;
      toX += 0.2f;
      fromY = toY;
    ...
    } else if (viewId == R.id.Button_Down_On_TranslateAnimationExample) {
      fromY = toY;
      toY += 0.2f;
      fromX = toX;
      TranslateAnimation moveBottom =
          new TranslateAnimation(
              Animation.RELATIVE_TO_SELF,
              fromX,
              Animation.RELATIVE_TO_SELF,
    ...
    } else if (viewId == R.id.Button_Left_On_ScaleAnimationExample) {
    ...
    } else if (viewId == R.id.Button_Right_On_ScaleAnimationExample) {
    ...
    } else if (viewId == R.id.Button_Left_On_ZoomAnimationExample) {
    ...
    } else if (viewId == R.id.Button_Right_On_ZoomAnimationExample) {
    ...
    } else if (viewId == R.id.Button_Left_On_SlideAnimationExample) {
      ScaleAnimation slideLeft =
          new ScaleAnimation(
              1.0f,
              0.0f,
              1.0f,
    ...
    } else if (viewId == R.id.Button_Up_On_SlideAnimationExample) {
    ...
    } else if (viewId == R.id.Button_Right_On_SlideAnimationExample) {
      ScaleAnimation slideRight =
          new ScaleAnimation(
              1.0f,
              0.0f,
              1.0f,
    ...
    } else if (viewId == R.id.Button_Down_On_SlideAnimationExample) {
      ScaleAnimation slideDown =
          new ScaleAnimation(
              1.0f,
              1.0f,
              1.0f,
    ...
    } else if (viewId == R.id.Button_On_BounceAnimationExample) {
      TranslateAnimation bounce =
          new TranslateAnimation(
              Animation.RELATIVE_TO_SELF,
              0.0f,
              Animation.RELATIVE_TO_SELF,
    ...
    } else if (viewId == R.id.Button_On_BlinkAnimationExample) {
    ...
    } else if (viewId == R.id.Button_On_SequentialAnimationExample) {
      ...
      findViewById(R.id.ImageView_On_SequentialAnimationExample)
          .startAnimation(getAnimationSet(false, t1, t2, t3, t4));
    } else if (viewId == R.id.Button_On_TogetherAnimationExample) {
      ScaleAnimation a1 =
          new ScaleAnimation(
              1.0f,
              1.6f,
      ...
      findViewById(R.id.ImageView_On_TogetherAnimationExample)
          .startAnimation(getAnimationSet(false, a1, a2, a3));
    } else if (viewId == R.id.Button_Left_On_SharedPreferenceExample) {
      putShare(
          KEY_DATA_SHARED_PREFERENCE_EXAMPLE,
          ((EditText) findViewById(R.id.EditText_On_SharedPreferenceExample)).getText().toString());
      toast("Data Saved Successfully");
    } else if (viewId == R.id.Button_Right_On_SharedPreferenceExample) {
      toast("DATA:" + getStringShare(KEY_DATA_SHARED_PREFERENCE_EXAMPLE, ""));
    } else if (viewId == R.id.Button_On_JSPNParsingExample) {
      try {
        TextView textView = findViewById(R.id.TextView_On_JSONParsingExample);
    ...
    } else if (viewId == R.id.Button_On_XMLParsingExample) {
      try {
        Document document =
    ...
    } else if (viewId == R.id.Button_On_SQLiteInsertExample) {
      String name =
          ((EditText) findViewById(R.id.EditText_Name_On_SQLiteInsertExample)).getText().toString();
      String sex =
          ((EditText) findViewById(R.id.EditText_Sex_On_SQLiteInsertExample)).getText().toString();
      String hobbies =
          ((EditText) findViewById(R.id.EditText_Hobbies_On_SQLiteInsertExample))
              .getText()
              .toString();
      ...
      if (insertOK) toast("Data Inserted Successfully");
      else toast("Data Insertion Failed");
    } else if (viewId == R.id.Button_On_SQLiteDeleteExample) {
      String idDelete =
          ((EditText) findViewById(R.id.EditText_Id_On_SQLiteDeleteExample)).getText().toString();
      toast("Rows:  " + new SQLiteOpenHelper().deleteData(idDelete) + " Affected");
    } else if (viewId == R.id.Button_On_SQLiteUpdateExample) {
      String idUpdate =
          ((EditText) findViewById(R.id.EditText_Id_On_SQLiteUpdateExample)).getText().toString();
      String nameUpdate =
          ((EditText) findViewById(R.id.EditText_Name_On_SQLiteUpdateExample)).getText().toString();
      String sexUpdate =
          ((EditText) findViewById(R.id.EditText_Sex_On_SQLiteUpdateExample)).getText().toString();
      String hobbiesUpdate =
          ((EditText) findViewById(R.id.EditText_Hobbies_On_SQLiteUpdateExample))
              .getText()
              .toString();

      boolean updateOK =
          new SQLiteOpenHelper().updateData(idUpdate, nameUpdate, sexUpdate, hobbiesUpdate);

      if (updateOK) toast("Data Updated Successfully");
      else toast("No Rows Affected");
    } else if (viewId == R.id.Button_On_SQLiteReadExample) {
      ((TextView) findViewById(R.id.TextView_On_SQLiteReadExample))
          .setText(new SQLiteOpenHelper().readData());
    } else if (viewId == R.id.Button_On_SimpleNotificationExample) {
      sendNotification(
          777,
          ...
          null,
          null);
    } else if (viewId == R.id.Button_On_InboxStyleNotificationExample) {
      NotificationCompat.InboxStyle inboxStyle = new NotificationCompat.InboxStyle();
      inboxStyle.setBigContentTitle("Inbox");
      for (int i = 0; i < 7; i++) inboxStyle.addLine(textSwitcherExampleTexts[i]);
      ...
      sendNotification(
          ...
          null,
          null);
    } else if (viewId == R.id.Button_On_BigTextStyleNotificationExample) {
      ...
      sendNotification(
          ...
          null,
          null);
    } else if (viewId == R.id.Button_On_BigPictureStyleNotificationExample) {
      ...
      sendNotification(
          ...
          null,
          null);
    } else if (viewId == R.id.Button_On_SnackBarExample) {
      Snackbar.make(view, "Welcome", Snackbar.LENGTH_SHORT)
          .setAction("OK", v -> toast("Clicked OK"))
          .show();
    } else if (viewId == R.id.Button_On_ToastExample) {
      ImageView imageView = new ImageView(getApplicationContext());
  ...
  protected void onUIState() {
    hideSystemBars();
    layoutInSystemBars();
    if (getLoadValue() == 18) setWindowDrawable(R.drawable.next_window_drawable_white);
    else setWindowDrawable(R.drawable.next_window_drawable);
  }
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode == REQUEST_OR_RESULT_CODE_CAMERA_EXAMPLE && resultCode == RESULT_OK)
      ((ImageView) findViewById(R.id.ImageView_On_CameraExample))
    ...
    if (resultCode == ForResultExample2.REQUEST_OR_RESULT_CODE_FOR_RESULT_EXAMPLE) {
      if (data.getStringExtra(ForResultExample2.EXTRA_FOR_RESULT_EXAMPLE).isEmpty())
        ...
        ((TextView) findViewById(R.id.TextView_On_ForResultExample))
            .setText(data.getStringExtra(ForResultExample2.EXTRA_FOR_RESULT_EXAMPLE));
    }
  }
  ...
  public void onRequestPermissionsResult(
    ...
    if (requestCode == REQUEST_PERMISSION_CODE_GET_PHONE_DETAILS
        && grantResults[0] == PackageManager.PERMISSION_GRANTED) phoneDetailsExample();
    else
      ((TextView) findViewById(R.id.TextView_On_GetPhoneDetailsExample))
          .setText("You don't have required permission \nto make the Action");
  }
  ...
  public void set(String data) {
    ((FragmentB)
            getSupportFragmentManager()
                .findFragmentById(R.id.Fragment_B_On_InterFragmentCommunicationExample))
        .setShow(data);
  }
  ...
  class AdapterViewFlipperAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      ((ImageView) convertView.findViewById(R.id.AdapterViewFlipper_Example_ImageView))
          .setImageResource(images[position]);
      ((TextView) convertView.findViewById(R.id.AdapterViewFlipper_Example_TextView))
  ...
  class SQLiteOpenHelper extends android.database.sqlite.SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "Tell";
    ...
    public synchronized String readData() {
      ...
      if (cursor != null && cursor.getCount() > 0) {
        ...
        while (cursor.moveToNext()) {
          ...
          query +=
              "Hobbies:  " + cursor.getString(cursor.getColumnIndex(COLUMN_HOBBIES)) + "\n\n\n";
        }

      } else query = "No Data to Retrieve";
