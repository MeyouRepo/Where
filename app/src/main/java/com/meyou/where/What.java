...
public class What extends Focus implements View.OnClickListener, View.OnTouchListener {
  ...
  private static final HashMap<String, Integer> EXTRAS = new HashMap<>();
  ...
  public static final String HOME_TO_NEXT_TITLE = "HOME_TO_NEXT_TITLE";

  public static final String NEXT_TO_HOME = "NEXT_TO_HOME";

  protected static final String SCROLLVIEW_BUTTON_NAME_ = "nextScrollViewButton_";
  ...
  protected final void topRightHide() {
    ...
    findViewById(R.id.nextScrollviewTopRight)
        .startAnimation(loadAnimation(R.anim.next_scrollview_top_right_hide));
  }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ((TextView) findViewById(R.id.nextTopTextView))
        .setText(getIntent().getStringExtra(HOME_TO_NEXT_TITLE));
  ...
  public void onClick(View v) {
    ...
    if (v.getId() == R.id.nextSeeRe) topRightHide();
    ...
    if (v.getId() == R.id.nextProperty) {
      startActivity(
          getIntent(More.class)
              ...
              .putExtra(
                  Common.PROPERTY_TITLE,
                  ((TextView) findViewById(R.id.nextTopTextView)).getText()));
    ...
    if (v.getId() == R.id.nextShow) {
      startActivity(
          getIntent(Show.class)
              .putExtra(
                  Common.SHOW_CODE_PASSING, getLoadValue() + EXTRAS.get(getClass().getSimpleName()))
              .putExtra(
                  Common.PROPERTY_TITLE,
                  ((TextView) findViewById(R.id.nextTopTextView)).getText()));
      overridePendingTransition(R.anim.next_yan, R.anim.next_to_code);
