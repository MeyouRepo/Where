            ...
            new Runnable() {
              ...
              public void run() {
                if (hasNetWork(context)) {
                  ...
                  try {
                    ...
                    if (httpURLConnection.getResponseCode() == HTTP_OK) {
                      ...
                      for (int threadId = 0; threadId < threadCount; threadId++) {
                        ...
                        if (threadId == (threadCount - 1)) endIndex = ((int) contentLength) - 1;
                  ...
                  ((Activity) context).runOnUiThread(() -> downloadListener.noNetWork());
                }
              }
            });
                          ...
                          ((Activity) context)
                              .runOnUiThread(
                                  new Runnable() {
                                    ...
                                    public void run() {
                                      percentage =
                                          ((int) ((float) current / (float) contentLength * 100))
                                              + "%";
